...
;testdir.gcode is designed to make this happen in the same direction repeatedly so the error can be detected.
...
;This program is to prove the drift does not happen if an axis does not reverse on itself. 
;
 G00 X0 Y0
 G01 Y10  ;move Y+ set X to go +
 G01 X10  ;move X+ set Y to go -
